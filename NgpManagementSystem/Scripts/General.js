...
function ContractorAnimation() {
    ...
    $("#paymentables").on('click', '.edityear3payment ', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#edityear3paymentform').find('input[name="commodity_year1"]').val(data.commodity_year1);
    ...
    $("#UpdateYear3Payment").click(function (e) {
        ...
        var data = {
            ...
            commodity_year1: $('#edityear3paymentform').find('input[name=commodity_year1]').val(),
            ...
            lddapno_year2_3rd: $('#edityear3paymentform').find('input[name=lddapno_year3_3rd]').val(),
            date_lddap_year2_3rd: $('#edityear3paymentform').find('input[name=date_lddap_year3_3rd]').val(),
